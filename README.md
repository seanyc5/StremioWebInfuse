...
- **Seamless Integration**: Works with any content source that Stremio supports
...
```
infuse://x-callback-url/play?url=https%3A//example.com/stream.m3u8
```
...
### Stream not playing
- Verify your content source is working properly
